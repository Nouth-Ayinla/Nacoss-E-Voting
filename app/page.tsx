        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <section className="text-center space-y-6 pt-6">
            <div className={`inline-flex items-center gap-2.5 px-4 py-2 rounded-full border shadow-sm transition-all duration-300 ${electionState === "ongoing"
              ...
              <span className="font-label-caps text-[11.5px] uppercase tracking-wider">
                {isScheduled
                  ? "Election Scheduled"
                  : electionState === "ongoing"
                    ? ""
            ...
            <div className="flex flex-col items-center justify-center gap-4 pt-2">
              {!election ? (
                ...
                <div className="space-y-6 w-full flex flex-col items-center">
                  {electionState === "ongoing" && (
                    <div className="w-full max-w-md mx-auto p-4 bg-emerald-50 border border-emerald-200 rounded-2xl flex items-center justify-center gap-3 shadow-sm animate-pulse">
                      <span className="w-3 h-3 rounded-full bg-emerald-500 animate-ping shrink-0" />
                      <span className="text-xs font-black text-emerald-800 uppercase tracking-widest text-center leading-none">
                        ELECTION IS LIVE & ONGOING
                      </span>
                    </div>
                  )}

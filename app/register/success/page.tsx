      ...
      <div className="w-full max-w-xl mx-auto flex flex-col items-center">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant w-full p-stack-lg rounded shadow-sm">
          <div className="flex flex-col items-center text-center mb-stack-lg">
            <div className="w-20 h-20 bg-primary/5 rounded-full flex items-center justify-center mb-stack-md">
              <span
                className="material-symbols-outlined text-primary text-6xl select-none"
            ...
            <p className="text-on-surface-variant mt-stack-sm max-w-md">
              Your details and student identification card are currently under review by the
              department&apos;s electoral committee. You will receive an email notification once
              your eligibility is verified.
            </p>
          </div>

          <div className="bg-surface-container-low border border-outline-variant rounded-lg p-stack-md mb-stack-lg">
            <div className="flex justify-between items-center mb-stack-sm border-b border-outline-variant pb-stack-xs">
              ...
              <span className="bg-primary-fixed-dim/20 text-on-primary-fixed-variant text-[10px] px-2 py-0.5 rounded font-bold uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 gap-stack-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className="font-technical-code text-technical-code text-primary-fixed-variant bg-surface-container-highest/50 px-2 py-1 rounded w-fit mt-1">
                  {matric || "—"}
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-stack-sm w-full">
            <button
              ...
              className="w-full bg-[#166534] hover:bg-[#14532d] text-white font-bold py-3 px-6 rounded-full transition-all duration-200 flex items-center justify-center gap-2"
            >
              Return to Login
              <span className="material-symbols-outlined text-sm">login</span>
            </button>
            <a
              className="w-full text-center py-2 text-primary font-bold font-body-sm hover:underline flex items-center justify-center gap-1"
              href="#"
            >
